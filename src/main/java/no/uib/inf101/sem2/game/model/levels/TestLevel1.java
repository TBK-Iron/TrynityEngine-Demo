...
public class TestLevel1 implements Level {
    ...
    public ArrayList<ShapeData> loadShapes() {
        ...
        shapes.add(new ShapeData(new Position3D(0, 0, 2.5f), new RelativeRotation((float) (Math.PI/10), (float) (Math.PI/4 - 0.2)), new File("src/main/resources/shapes/cube.trym")));
